...
- k-Nearest neighbors regression\index{k-nearest neighbors regression}
- Naive Bayes\index{Naive Bayes}
- Support Vector Machines\index{support vector machines}, Boltzmann Machines
- Projection pursuit regression, Multivariate Adaptive Regression Splines (MARS)\index{projection pursuit regression}
- (Hidden) Markov Models\index{hidden Markov models}
- Undirected graphs, Markov Random Fields, Network analysis\index{undirected graphs}
...
- PCA, probabilistic PCA, ICA, SVD\index{principal component analysis}\index{independent component analysis}
- Latent Dirichlet Allocation (LDA), Latent Semantic Analysis (LSA)\index{latent Dirichlet allocation}\index{latent semantic analysis}
- (Non-negative) Matrix Factorization (NMF)\index{non-negative matrix factorization}
- Dirichlet process
- Recommender systems and collaborative filtering\index{recommender systems}

**Clustering**

- t-SNE\inex{t-SNE}
- (H)DBSCAN\index{DBSCAN}
- k-means, k-medoids\index{k-means}\index{k-medoids}
- Hierarchical clustering\index{hierarchical clustering}
- Fuzzy clustering\index{fuzzy clustering}
- Spectral clustering\index{spectral clustering}
- Self-organizing maps\index{self-organizing maps}
...
- Convolutional Neural Networks\index{convolutional neural networks}
- Recurrent Neural Networks\index{recurrent neural networks}
- Long Short-Term Memory Networks\index{long short-term memory networks}
- Transformers/Attention Mechanisms\index{transformers}\index{attention mechanisms}
- Autoencoders\index{autoencoders}
- Generative Adversarial Networks\index{generative adversarial networks}
- Graph Neural Networks\index{graph neural networks}
- Reinforcement Learning\index{reinforcement learning}
