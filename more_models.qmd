...
You'll also find deep learning approaches to some of the models in the ML section, such as recommender systems, clustering, graphs and more. Michael has surveyed some of the developments in deep learning for tabular data (@clark_deep_2022), and though he hasn't seen anything as of this writing to change the general conclusion there, he hopes to revisit the topic in earnest again in the future, so stay tuned.
:::
