...
[Mean squared error]{.subsub}{#sec-knowing-metrics-mse}
...
[Mean absolute error]{#sec-knowing-metrics-mae .subsub}
...
[Mean absolute percentage error]{#sec-knowing-metrics-mape .subsub}
...
[Which regression metric should I use?]{#sec-knowing-which-reg-metrics .subsub}
...
[Confusion matrix]{#sec-knowing-metrics-confusion .subsub}
...
<!-- TODO: Maybe just table these up? But then we have two tables of similar content -->

[Accuracy]{#sec-knowing-metrics-accuracy .subsub}
...
[Sensitivity/Recall/True positive rate]{#sec-knowing-metrics-sensitivity .subsub}
...
[Specificity/True negative rate]{#sec-knowing-metrics-specificity .subsub}
...
[Precision/Positive predictive value]{#sec-knowing-metrics-precision .subsub}
...
[Negative predictive value]{#sec-knowing-metrics-npv .subsub}
