...
\index{Receiver Operating Characteristic (ROC) curve|see{AUROC Curve}}
\index{Area under a ROC curve|see{AUROC Curve}}
...
\index{metrics!AUPRC}
\index{Area under the precision-recall curve|see{AUPRC}}
