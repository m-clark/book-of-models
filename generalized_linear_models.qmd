...
:::{.callout type='note' title='Binomial Regression' collapse='true'}
...
:::{.callout type='note' title='A Note on $R^2$ for Logistic Regression' collapse='true'}
...
:::{.callout type='note' title='More Poisson' collapse='true'}
...
:::{.callout type='note' title='Nonlinear linear models?' collapse='true'}
