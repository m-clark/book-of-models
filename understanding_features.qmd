...
We'll use the same data as our with @sec-knowing, and this is just the key code from there.
...
<!-- TODO: as this is the only example in this chap to not use reviews, maybe rethink for consistency -->
...
It's generally a good idea to look at which features are pulling the most weight in your model to better understand how predictions are being made. It takes a lot of work to trust what a model is telling you.
...
- Create a counterfactual prediction for 
