...
This was more revised than cut
 ...
 We can find the rate by determining the number of events per interval, multiplied by the interval length.
...
ggsave(
  'img/glm-poisson-distribution.svg',
  p,
  width = 8,
  height = 6,
)
...
![Poisson distribution for a rate of 4](img/glm-poisson-distribution.svg)
:::
