...
ggsave("img/lm-extend-interaction_plot.svg")
```
:::
...
ggsave("img/lm-extend-length_release_rating.svg")
```
:::
:::{.content-visible when-format="pdf"}
...
ggsave("img/lm-extend-length_genre_rating.svg")
...
ggsave("img/lm-extend-length_release_rating_year.svg")
...
ggsave("img/lm-extend-random_effects.svg")
```
:::
:::{.content-visible when-format="pdf"}
![Random effects for mixed model](img/lm-extend-random_effects.svg){#fig-random-effects}
:::
...
ggsave("img/lm-extend-random_effects_cor_plot.svg")
```
:::
:::{.content-visible when-format="pdf"}
...
ggsave("img/lm-extend-linear_effect.svg")
```
:::
...
ggsave("img/lm-extend-nonlinear_effect.svg")
```
:::
...
ggsave("img/lm-extend-gam_plot.svg")
```
:::
...
> Oh, you think the median is your ally. But you merely adopted the median. I was born in it, molded by it. I didn't see anything interesting until I was already a data scientist, and by then it was nothing to me but misleading.
> -- Bane (probably)
