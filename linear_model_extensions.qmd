...
![Interaction plot.](img/lm-extend-interaction_plot.svg){#fig-model-interaction-plot width=90%}
:::
...
\index{mixed models|(}\index{linear model!mixed models|see{mixed models}}\index{hierarchical linear models|see{mixed models}}\index{multilevel models|see{mixed models}}\index{random effects|see{mixed models}}\index{nonlinear models!random slopes}
...
:::
:::{.content-visible when-format='pdf'}
![Linear relationship between length of movie and rating.](img/lm-extend-length_release_rating.svg){#fig-length-release-rating width=90%}
:::
...
![Estimated random effects.](img/lm-extend-random_effects.svg){#fig-random-effects width=90%}
