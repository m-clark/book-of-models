...
ggeffects::ggpredict(model, terms = 'x') |> 
    ...
    scale_y_continuous(breaks = c(seq(.4, .6, .05), seq(.5, .55, .01)), labels = scales::label_percent())
