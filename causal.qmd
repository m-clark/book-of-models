...
[^diffindiff]: Difference-in-differences just involves an interaction of a treatment with something else, typically time. 

[^iv]: Instrumental variables are used in econometrics, and are a way to get around the problem of unmeasured confounding.

[^semass]: Mediation/moderation are special applications of structural equation modeling.
