...
## Feature & Target Transformations {#sec-data-transfromations}
...
:::{.callout-tip}
It's almost always a good idea to apply transformations to your data. Aside from tree-based approaches (TODO: LINK), which bin or discretize the data regardless of scale, most modeling approaches benefit in some way or another from transformations.
:::
