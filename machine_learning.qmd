...
![Train-Validation-Test Workflow](img/sklearn_k_fold_images/model_logistic_grid_workflow.png){width='100%'}

![5-fold Cross-Validation](img/sklearn_k_fold_images/model_logistic_grid_cross_validation.png){width='100%'}
