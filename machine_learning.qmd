...
[^bad-print]: These images likely don't work well for black-white printing but there are multiple groups and using a bunch of different patterns would make the problem worse. We invite you to examine the pdf or web version.
