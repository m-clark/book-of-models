...
### Using metrics for model evaluation and selection {#sec-ml-metrics}
...
<!-- TODO: add conformal prediction discussion? -->
...
So there you have it. We searched the parameter space, chose the best set of parameters via k-fold cross validation, and got an assessment of generalization error in just a couple lines of code. Neat!
