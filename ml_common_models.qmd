...
![The first hidden layer.](img/nn_first_hidden_layer.svg){#fig-first-layer}
:::
...
:::{.content-visible when-format="html"}
![Activation function transforms node output before the next layer.](img/nn_activation2.svg){#fig-activate}
:::
:::{.content-visible when-format="html"}
