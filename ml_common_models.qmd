...
```{r}
#| label: fig-benchmark-r
#| echo: false
#| fig-cap: Training results for tuned models.
...
feature_importances.head(4).to_html()
...
> **The best model is just the one that works best.**
