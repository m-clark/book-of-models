...
tibble(
    ...
    tab_footnote(
        md("Confidence intervals are for the difference in proportions at values of .75 and .73, and p-values are for the difference in proportions.")
