...
\index{activation functions!hyperbolic tangent}
\index{activation functions!linear}
...
The neural network model we'll use is a **multilayer perceptron** (MLP)\index{multilayer perceptron}, which is a model like the one we've been showing. It consists of multiple hidden layers of potentially varying sizes, and we can incorporate activation functions as we see fit. 
