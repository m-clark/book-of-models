...
result = map(
  list(model_3, model_lr_train, model_3_int), 
...
# get the predictions, calculate RMSE
models = [model_3, model_lr_train, model_3_int]
...
ggsave("img/knowing-pdp-ice-ale.svg", width = 8, height = 6)
```

:::

:::{.content-visible when-format='pdf'}
![PDP, ICE, and ALE Plots](img/knowing-pdp-ice-ale.svg)
:::
...
interaction_plot = interaction |> 
    ...
    guides(color = guide_legend(title = "Feature 2"), linetype = 'none') +
...
ggsave("img/knowing-feature-importance.svg", width = 8, height = 5)
```
:::

:::{.content-visible when-format='pdf'}
![Two plots showing the importance of understanding feature interactions and non-linear relationships](img/knowing-feature-importance.svg)
:::
...
:::{.content-visible when-format='pdf'}
![Feature Importance by Various Methods](img/knowing-feature-importance-2.svg)
:::
