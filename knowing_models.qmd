...
<!-- TODO: double check this cluster for R. it seems whatever package you pick will only give you half of what you want -->
...
<!-- TODO: under the hood each iteration vs explictly pitting models against one another -->
...
Use the world happiness data set to create a linear model that predicts happiness score. 

## 

@google_classification_2024