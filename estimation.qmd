...
p_ols = guesses |>
    ...
    annotate(
        ...
        x = min_loss$b0, 
        y = min_loss$b1,
        label = glue("Our minimum at ({round(min_loss$b0, 2)}, {round(min_loss$b1, 3)})
    ...
    #     ylim = c(-1, 1)
    # ) +
    scico::scale_fill_scico(begin = .1, end = 1, direction = 1) +
    labs(
        x = "b0",
        y = "b1",
