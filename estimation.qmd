...
$$
\mu = \beta_0 + \beta_1 * \text{life\_exp}
$$
$$
\text{happiness} \sim N(\mu, \sigma)
$$
...
$$
\text{Pr}(\text{happiness} \mid \text{life\_exp}, \beta_0, \beta_1, \sigma)
$$

$$
\text{Pr}(\text{happiness} \mid \mu, \sigma)
$$
...
#### Additional Thoughts on Maximum Likelihood  {#sec-estim-maxlike-add}
