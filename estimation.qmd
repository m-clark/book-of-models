...
A few concepts we'll keep using here are fundamental to understanding estimation and optimization.  Most of them we've seen before, but we'll be getting a bit cozier with them now.
