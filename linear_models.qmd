...
p_ecdf = tibble(res = abs(resid(model_reviews))) |>
    ...
    geom_vline(xintercept = mean(abs(resid(model_reviews))), color = okabe_ito['darkblue'], alpha = 1) +
...
summary(model_reviews)$sigma   # We can extract it directly
```
