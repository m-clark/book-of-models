...
gganimate::anim_save(
    "img/linear_model/corr_anim.gif", anim, fps = 1, duration = 10, width = 600, height = 600
    )
```

![](img/linear_model/corr_anim.gif)
