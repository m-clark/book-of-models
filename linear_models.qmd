...
### Models as a Graph {#sec-lm-graph}
...
![A Linear Model with Transformation Can Be a Logistic Regression](img/graphical_logistic.svg){width=75%}
...
But there are many, many books on statistical analysis, linear models, and linear regression specifically. There are those that show nothing but applied results, and those that are very theoretical. They get more mathy and theoretical as you go back in time, to mostly applied treatments today. You will likely need to do a lot of perusing to find one you like best.
