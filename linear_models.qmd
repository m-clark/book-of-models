...
[^dimsRwhut]: It never ceases to amaze us how many papers show matrix/vector operations without specifying the dimensions of what's involved, even though it's key to understanding what's being depicted. Even better would be simple code demonstration, but that's rare.
...
### Assumptions fo More Complex Models {#sec-lm-assumption-complex}
...
Import some data. Stick with the movie reviews data if you want and just try out other features, or maybe try the world happiness data 2018 data. You can find details about it in the appendix @sec-dd-world-happiness-report, can download it [here](https://raw.githubusercontent.com/m-clark/book-of-models/main/data/world_happiness_2018.csv).

<!-- TODO: ADD/CHECK DATA LINK -->
