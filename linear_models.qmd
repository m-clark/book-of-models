...
mre_mae = round(performance::mae(model_reviews_extra), 2)
```
...
graph LR
    n1((X<sub>1</sub>)) --> |b<sub>1</sub>| n4((*))
    n2((X<sub>2</sub>)) --> |b<sub>2</sub>| n4((*))
    n3((X<sub>3</sub>)) --> |b<sub>3</sub>| n4((*))
