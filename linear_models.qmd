...
<!-- 
do some latex fix for pdf due to ridiculous 'Notes' that should be documented and not part of the output. Note that this suggestion affects the code too, so not any better than just using the standard text size change.
...
![A linear regression as a graphical model](img/graphical_lm.svg){width=50%}
