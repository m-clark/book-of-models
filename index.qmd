...
![](img/chapter_gp_plots/gp_plot_20.svg){width=75% fig-align='center'}
:::
...
Also, if you prefer the print version, you can find it at [Routledge](https://www.routledge.com/Models-Demystified-A-Practical-Guide-from-Linear-Regression-to-Deep-Learning/Clark-Berry/p/book/9781032582580) (use code **25ESA3** for a 20% discount through 2025) or [Amazon](https://www.amazon.com/Models-Demystified-Chapman-Hall-Science/dp/1032582588). 
...
## Data and Code {#sec-preface-data}
...
He also maintains a [blog](https://m-clark.github.io) covering many aspects of statistical and machine learning modeling, and has several posts and long-form documents on a variety of data science topics there. He lives in Ann Arbor, Michigan with his wife and his dog, where they all enjoy long walks around the neighborhood. During the course of writing this book, he became a father to Juni, and he is now learning the joys of sleep deprivation.
