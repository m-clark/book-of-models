...
<!-- TODO: change this image since it's color -->

:::{.content-visible when-format='pdf'}
![Spatial Demographic Data (code available from [Kyle Walker](https://github.com/walkerke/mb-immigrants))](img/ml-spatial-kw.png){width=75%}
:::
