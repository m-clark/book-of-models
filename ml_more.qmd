...
<!-- TODO: port your torch_frame example here -->
...
- A Visual Introduction to LLMs (@raschka_visual_2023)
- Build a LLM from Scratch (@3blue1brown_how_2024)
...
- Self-supervised learning: The dark matter of intelligence (@lecun_self_2021)